...
"""
@author: RZH
@file: getBatchSize.py
@time: 2023/8/14 17:14
@project getBatchSize
@IDE PyCharm
"""
import torch
import typing as t
...
def t_test(model: nn.Module, test_ds: DataLoader, device: torch.device):
    with torch.no_grad():
        model.eval()
...
def main(epochs: int = 2):
    ...
    for epoch in range(1, epochs + 1):
        ...
        test_result = t_test(model=model, test_ds=test_ds, device=device)
        print(
